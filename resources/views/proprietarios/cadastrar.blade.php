...
<div ng-controller="proprietariosController">
<form name="cadastro_proprietario" method="post"  >

<div class="container max-width-block z-depth-2 padding-bottom">

	<div class="header-area-1 padding-side">
		<h4>Dados Básicos</h4>
		<h6>Cadastro Proprietário</h6>
	</div>
...
<div class="container max-width-block z-depth-2 padding-bottom">
	...
	<div class="row padding-side padding-top">
		...
		<div class="input-field col s12 m6 l6">
			<select>
				<option value="" disabled selected name="filial_id" ng-model="filial_id">Selecione</option>
		...
		<div class="input-field col s12 m6 l6">
			<select>
				<option value="" disabled selected name="gerente_id" ng-model="gerente_id">Selecione</option>
				<option value="117574494776459622520">Eduardo</option>
				<option value="117574494776459622520">Robson</option>
				<option value="117574494776459622520">Hugo</option>
			</select>
			<label>Gerente</label>
		</div>
	...
	<div class="row padding-side">
		<div class="col s6 m3 l3">
			<p>
		      <input type="checkbox" id="dimob" name="dimob" ng-model="dimob"/>
		      <label for="dimob">DIMOB</label>
		    </p>
	    </div>
		<div class="col s6 m3 l3">
			<p>
		      <input type="checkbox" id="reside_exterior" ng-model="reside_exterior" />
		      <label for="reside_exterior">RESIDE EXTERIOR</label>
		    </p>
		</div>
		<div class="col s6 m3 l3">
			<p>
		      <input type="checkbox" id="darf" name="darf" ng-model="darf" />
		      <label for="darf">DARF</label>
		    </p>
		</div>
		<div class="col s6 m3 l3">
			<p>
		      <input type="checkbox" id="retencao_irrf" name="retencao_irrf" ng-model="retencao_irrf" />
		      <label for="retencao_irrf">RETENÇÃO IRRF</label>
		    </p>
		</div>
	</div>
