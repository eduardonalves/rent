...
<div ng-controller="contasVerController" class="row col s12">
<form name="cadastro_conta" method="post" ng-repeat="cont in contas" >
  ...
  <div class="container max-width-block z-depth-2 padding-bottom">
  	...
  	<div class="row padding-side padding-top">
          <div class="input-field col s12 m8 l9">
  			       <input readonly id="nome_da_conta" type="text" class="validate" ng-model="cont.nome_da_conta" >
  			        <label class="active" for="nome_da_conta">Nome da Conta</label>
          </div>

          <div class="col s12 m4 l3 switch">
    		    <label class="active center_table_label">
    		      Inativo
    		      <input readonly type="checkbox" checked="checked" ng-model="cont.situacao">
