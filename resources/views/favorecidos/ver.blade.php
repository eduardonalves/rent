...
<div ng-controller="favorecidosVerController" class="row col s12">
...
<div class="container max-width-block z-depth-2 padding-bottom">
	...
	<div class="row padding-side padding-top">
        <div class="input-field col s12 m8 l9">
            <input readonly id="codigointerno" type="text" class="validate" ng-model="fav.codigointerno" >
            <label class="active" for="codigointerno">Código</label>
        </div>
        <div class="input-field col s12 m6 l3">
          <select readonly ng-model="fav.tipo_pessoa" name="tipo_pessoa">
        ...
        <div class="input-field col s12 m8 l9">
             <input readonly  id="cnpj" type="text" class="validate" ng-model="fav.cnpj" >
                <label for="cnpj" class="active">CNPJ</label>
        </div>
        <div class="input-field col s12 m8 l9">
             <input readonly id="ie" type="text" class="validate" ng-model="fav.ie" >
                <label for="ie" class="active">Inscrição Estadual</label>
        </div>
        <div class="input-field col s12 m8 l9">
             <input readonly id="im" type="text" class="validate" ng-model="fav.im" >
              <label for="im"class="active" >Inscrição Municipal</label>
        </div>
        <div class="input-field col s6 m6 l2">
        <input readonly type="date" class="datepicker" placeholder="Data de Abertura" ng-model="fav.data_abertura">
        <label for="orgao_emissor" class="active">Data de Abertura</label>
        </div>
        <div class="input-field col s12 m8 l9">
			       <input readonly id="nome" type="text" class="validate" ng-model="fav.nome" >
        ...
        <div class="col s12 m4 l3 switch">
		    <label class="active center_table_label">
		      Inativo
		      <input readonly type="checkbox" checked="checked" ng-model="fav.situacao">
	...
	<div class="row padding-side">
        ...
        <div class="input-field col s12 m6 l6">
			<input readonly id="email" type="email" class="validate" ng-model="fav.email">
			<label class="active" for="email">Email</label>
        </div>

        <div class="input-field col s12 m6 l6">
			<input readonly id="site" type="text" class="validate" name="site" ng-model="fav.site">
	...
	<div class="row padding-side">
        ...
        <div class="input-field col s12 m6 l4">
			<input readonly id="cpf" type="number" class="validate"  /name="cpf" ng-model="fav.cpf">
			<label class="active" for="cpf">CPF</label>
        </div>

        <div class="input-field col s12 m6 l4">
			<input readonly id="rg" type="number" class="validate" name="rg" ng-model="fav.rg">
			<label class="active" for="rg">RG</label>
        </div>

        <div class="input-field col s6 m6 l2">
			<input readonly id="orgao_emissor" type="text" class="validate" name="orgao_emissor" ng-model="fav.orgao_emissor">
			<label class="active" for="orgao_emissor">Órgão Emissor</label>
        </div>

        <div class="input-field col s6 m6 l2">
				<input readonly type="date" class="datepicker" placeholder="Data de Emissão" ng-model="fav.data_emissao">
        </div>
	...
	<div class="row padding-side">
		...
		<div class="input-field col s12 m6 l3">
			<select readonly ng-model="fav.sexo" name="sexo">
		...
		<div class="input-field col s12 m6 l3">
			<select readonly ng-model="fav.estado_civil" name="estado_civil">
				<option value="" disabled >Selecione</option>
        ...
        <div class="input-field col s12 m6 l3">
			<input readonly id="nacionalidade" type="text" class="validate" ng-model="fav.nacionalidade">
			<label class="active" for="nacionalidade">Nacionalidade</label>
        </div>

        <div class="input-field col s12 m6 l3">
			<input readonly id="naturalidade" type="text" class="validate"  ng-model="fav.naturalidade">
	...
	<div class="row padding-side">
        ...
        <div class="input-field col s12 m5 l5">
			<input readonly id="profissao" type="text" class="validate" ng-model="fav.profissao">
			<label class="active" for="profissao">Profissão</label>
        </div>

        <div class="input-field col s12 m5 l5">
			<input readonly id="empresa" type="text" class="validate" name="empresa" ng-model="fav.empresa">
			<label class="active" for="empresa">Empresa</label>
        </div>

        <div class="input-field col s12 m2 l2">
			<input readonly id="renda" type="number" class="validate" ng-model="fav.renda">
	...
	<div class="row padding-side">
        ...
        <div class="input-field col s12 m7 l7">
			<input readonly id="nome_conjuge" type="text" class="validate" ng-model="fav.nome_conjuge">
			<label class="active" for="nome_conjuge">Nome do Cônjuge</label>
        </div>

        <div class="input-field col s12 m5 l5">
			<input readonly id="cpf_conjugue" type="number" class="validate" name="cpf_conjugue" ng-model="fav.cpf_conjugue">
...
<div class="container max-width-block z-depth-2 padding-bottom">
	...
	<div class="row padding-side padding-top">
		...
		<div class="input-field col s12 m6 l6">
			<select readonly name="tipo_imovel" ng-model="fav.tipo_imovel">
				<option value="" disabled >Selecione</option>
		...
		<div class="input-field col s12 m6 l6">
			<select readonly name="tipo_endereco" ng-model="fav.tipo_endereco">
				<option value="" disabled >Selecione</option>
	...
	<div class="row padding-side">
		...
		<div class="input-field col s12 m6">
			<input readonly id="endereco" type="text" class="validate" ng-model="fav.endereco">
		    <label class="active" for="endereco">Endereço</label>
		</div>

		<div class="input-field col s12 m6">
			<input readonly id="complemento" type="text" class="validate" ng-model="fav.complemento">
	...
	<div class="row padding-side">
		...
		<div class="input-field col s12 m5 l5">
			<select readonly name="bairro" ng-model="fav.bairro">
				<option value="" disabled >Selecione</option>
		...
		<div class="input-field col s12 m5 l5">
			<select readonly name="cidade" ng-model="fav.cidade">
				<option value="" disabled >Selecione</option>
		...
		<div class="input-field col s12 m2 l2">
			<select readonly name="uf" ng-model="fav.uf">
				<option value="" disabled >Selecione</option>
...
<div class="container max-width-block z-depth-2 padding-bottom">
	...
	<div class="row padding-side padding-top">
		...
		<div class="input-field col s12 m3 l3">
			<input readonly id="codigo_banco" type="number" class="validate" name="codigo_banco" ng-model="fav.codigo_banco">
		    <label class="active" for="codigo_banco">Código do Banco</label>
		</div>

		<div class="input-field col s12 m4 l4">
			<input readonly id="banco" type="text" class="validate" name="banco" ng-model="fav.banco">
		    <label class="active" for="banco">Banco</label>
		</div>

		<div class="input-field col s12 m5 l5">
			<input readonly id="codigo_reconhecimento" type="number" class="validate" name="codigo_reconhecimento" ng-model="fav.codigo_reconhecimento">
	...
	<div class="row padding-side">
		...
		<div class="input-field col s12 m4">
			<input readonly id="agencia" type="number" class="validate" name="agencia" ng-model="fav.agencia">
		    <label class="active" for="agencia">Agência</label>
		</div>
    <div class="input-field col s12 m4">
      <input readonly id="agencia_nome" type="text" class="validate" name="agencia_nome" ng-model="fav.agencia_nome">
        <label class="active" for="agencia_nome">Nome da Agência</label>
    </div>
		<div class="input-field col s12 m8">
			<input readonly id="conta_corrente" type="number" class="validate" name="conta_corrente" ng-model="fav.conta_corrente">
