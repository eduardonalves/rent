function createProprietarioObj($scope) {
...
var site=$scope.site || null;
  ...
  var dimob=$scope.dimob || null;
  var reside_exterior=$scope.reside_exterior || null;
  var darf=$scope.darf || null;
  var retencao_irrf=$scope.retencao_irrf || null;
  ...
  var filial_id = $scope.filial_id || null;
  var gerente_id = $scope.gerente_id || null;
  var objetoProp ={
    Proprietario:{
      nome :nome,
      situacao :situacao,
